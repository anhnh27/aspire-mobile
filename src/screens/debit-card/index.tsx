...
const ActionItem = (props: ActionItemProps) => {
  const {source, name, description, onPress} = props;
  return (
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardContentRow3}>
            ...
            <Text style={[styles.cardLast4Number, styles.ml24]}>
              {cardInfo?.data?.last4Digits}
            </Text>
          </View>
          <View style={styles.cardContentRow4}>
            <Text
              style={
                styles.validThruText
              }>{`Thru: ${cardInfo?.data?.validThru}`}</Text>
      ...
      <View style={styles.weeklyLimitChartContainer}>
        <BarChart currentValue={250} totalValue={1000} />
      </View>
      <View style={styles.actionContainer}>
        ...
        <ActionItem
          ...
          description={STRINGS.spending_limit_action_desc}
